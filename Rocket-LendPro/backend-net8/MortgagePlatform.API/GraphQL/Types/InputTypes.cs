...
public record UpdateUserRoleInput(int UserId, string NewRole);
public record ChangePasswordInput(string CurrentPassword, string NewPassword, string ConfirmNewPassword);
