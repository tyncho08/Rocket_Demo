...
namespace MortgagePlatform.API.Services
{
    public class LoanService : ILoanService
    {
        ...
        public async Task<LoanDocumentDto> UploadDocumentAsync(UploadDocumentDto dto)
        {
            // Save file to storage (for demo, we'll just use a simple path)
            ...
            await File.WriteAllBytesAsync(filePath, dto.FileData);
